...
import { type LucideIcon, ArrowUpRight, Eye, EyeOff, Gamepad2, LoaderCircle, Lock, Mail, Moon, ShieldCheck, Sun, User, UserPlus } from 'lucide-react';
    ...
    <main className="relative mx-auto flex w-full max-w-7xl flex-1 min-h-[100dvh] items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="relative z-10 grid w-full flex-1 gap-6 lg:grid-cols-2 lg:items-stretch max-w-5xl">
        <motion.section
          ...
          className="auth-hero-panel hidden h-full min-h-[580px] sm:min-h-[600px] w-full flex-col justify-between p-6 sm:p-8 lg:flex"
        >
          <div>
        ...
        <motion.section
          ...
          className="glass-panel flex h-full min-h-[580px] sm:min-h-[600px] w-full flex-col justify-between p-6 sm:p-8"
        >
          ...
          <form className="flex-1 flex flex-col justify-between" onSubmit={onSubmit}>
            <div className="min-h-[288px] flex flex-col justify-center space-y-4 py-2">
              {!isLogin && (
                <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-black/10 dark:border-white/10 bg-transparent py-2.5 pl-9 pr-10 text-sm text-[var(--text-main)] outline-none transition-colors placeholder:text-[var(--text-soft)] focus:border-[var(--text-main)]"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-[var(--text-soft)] hover:text-[var(--text-main)] transition-colors focus:outline-none"
            ...
            <div>
              ...
              <button
                ...
                className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[var(--ink-main)] px-4 py-2.5 font-mono text-xs uppercase tracking-wider text-white dark:bg-white dark:text-black font-medium transition-opacity hover:opacity-90 disabled:opacity-50"
              >
                {authSubmitting ? (
                  <>
